  ...
  return (
    <div className="space-y-8">
      ...
      <section className="space-y-3">
        <h2 className="text-sm font-medium text-foreground">Événements</h2>
      ...
      <section className="space-y-3">
        <h2 className="text-sm font-medium text-foreground">Opportunités liées</h2>
        {linkedOpps.length === 0 ? (
            ...
            {linkedOpps.map((o) => (
              <li key={o.id} className="flex flex-wrap items-center justify-between gap-2 px-4 py-2.5 text-sm">
                <div className="flex flex-wrap items-center gap-2">
                  <Link href={`/deals/${o.id}`} className="font-medium text-foreground hover:underline">
                    {o.name}
                  </Link>
